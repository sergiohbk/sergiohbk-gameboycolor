...
export class CPU{
  ...
  instructionSet(opcode: number) {
    ...
    switch (opcode) {
      ...
      case 0x86:
        //ADD A, (HL)
        this.A = this.addSub("add", this.A, this.memory.read(this.getHL()), 8);
        this.cycles.sumCycles(8);
        break;
      case 0x87:
        //ADD A, A
      ...
      case 0x8e:
        //ADC A, (HL)
        this.A = this.addSub("adc", this.A, this.memory.read(this.getHL()), 8);
        this.cycles.sumCycles(8);
        break;
      case 0x8f:
        //ADC A, A
      ...
      case 0x96:
        //SUB A, (HL)
        this.A = this.addSub("sub", this.A, this.memory.read(this.getHL()), 8);
        this.cycles.sumCycles(8);
        break;
      case 0x97:
        //SUB A, A
      ...
      case 0x9e:
        //SBC A, (HL)
        this.A = this.addSub("sbc", this.A, this.memory.read(this.getHL()), 8);
        this.cycles.sumCycles(8);
        break;
      case 0x9f:
        //SBC A, A
      ...
      case 0xa6:
        //AND A, (HL)
        this.A = this.logicalOps("and", this.A, this.memory.read(this.getHL()));
        this.cycles.sumCycles(8);
        break;
      case 0xa7:
        //AND A, A
      ...
      case 0xae:
        //XOR A, (HL)
        this.A = this.logicalOps("xor", this.A, this.memory.read(this.getHL()));
        this.cycles.sumCycles(8);
        break;
      case 0xaf:
        //XOR A, A
      ...
      case 0xb6:
        //OR A, (HL)
        this.A = this.logicalOps("or", this.A, this.memory.read(this.getHL()));
        this.cycles.sumCycles(8);
        break;
      case 0xb7:
        //OR A, A
      ...
      case 0xbe:
        //CP A, (HL)
        this.logicalOps("cp", this.A, this.memory.read(this.getHL()));
        this.cycles.sumCycles(8);
        break;
      case 0xbf:
        //CP A, A
      ...
      case 0xc6:
        //ADD A, n
        this.A = this.addSub("add", this.A, this.memory.read(this.PC), 8);
        this.pcIncrement(1);
        this.cycles.sumCycles(8);
        break;
      case 0xc7:
      ...
      case 0xcb:
        ...
        switch (this.memory.read(this.PC + 1)) {
          ...
          case 0x06:
            ...
            this.memory.write(
              this.getHL(),
              this.rotShift("RLC", this.memory.read(this.getHL()))
            );
            this.pcIncrement(1);
            this.cycles.sumCycles(16);
            break;
          ...
          case 0x0e:
            ...
            this.memory.write(
              this.getHL(),
              this.rotShift("RRC", this.memory.read(this.getHL()))
            );
            this.pcIncrement(1);
            this.cycles.sumCycles(16);
            break;
          ...
          case 0x16:
            ...
            this.memory.write(
              this.getHL(),
              this.rotShift("RL", this.memory.read(this.getHL()))
            );
            this.pcIncrement(1);
            this.cycles.sumCycles(16);
            break;
          ...
          case 0x1e:
            ...
            this.memory.write(
              this.getHL(),
              this.rotShift("RR", this.memory.read(this.getHL()))
            );
            this.pcIncrement(1);
            this.cycles.sumCycles(16);
            break;
          ...
          case 0x26:
            ...
            this.memory.write(
              this.getHL(),
              this.rotShift("SLA", this.memory.read(this.getHL()))
            );
            this.pcIncrement(1);
            this.cycles.sumCycles(16);
            break;
          ...
          case 0x2e:
            ...
            this.memory.write(
              this.getHL(),
              this.rotShift("SRA", this.memory.read(this.getHL()))
            );
            this.pcIncrement(1);
            this.cycles.sumCycles(16);
            break;
          ...
          case 0x36:
            ...
            this.memory.write(
              this.getHL(),
              this.rotShift("SWAP", this.memory.read(this.getHL()))
            );
            this.pcIncrement(1);
            this.cycles.sumCycles(16);
            break;
          ...
          case 0x3e:
            ...
            this.memory.write(
              this.getHL(),
              this.rotShift("SRL", this.memory.read(this.getHL()))
            );
            this.pcIncrement(1);
            this.cycles.sumCycles(16);
            break;
          ...
          case 0x46:
            //BIT 0, (HL)
            this.bitOps("bit", 0, this.memory.read(this.getHL()));
            this.pcIncrement(1);
            this.cycles.sumCycles(12);
            break;
          case 0x47:
          ...
          case 0x4e:
            //BIT 1, (HL)
            this.bitOps("bit", 1, this.memory.read(this.getHL()));
            this.pcIncrement(1);
            this.cycles.sumCycles(12);
            break;
          case 0x4f:
          ...
          case 0x56:
            //BIT 2, (HL)
            this.bitOps("bit", 2, this.memory.read(this.getHL()));
            this.pcIncrement(1);
            this.cycles.sumCycles(12);
            break;
          case 0x57:
          ...
          case 0x5e:
            //BIT 3, (HL)
            this.bitOps("bit", 3, this.memory.read(this.getHL()));
            this.pcIncrement(1);
            this.cycles.sumCycles(12);
            break;
          case 0x5f:
          ...
          case 0x66:
            //BIT 4, (HL)
            this.bitOps("bit", 4, this.memory.read(this.getHL()));
            this.pcIncrement(1);
            this.cycles.sumCycles(12);
            break;
          case 0x67:
          ...
          case 0x6e:
            //BIT 5, (HL)
            this.bitOps("bit", 5, this.memory.read(this.getHL()));
            this.pcIncrement(1);
            this.cycles.sumCycles(12);
            break;
          case 0x6f:
          ...
          case 0x76:
            //BIT 6, (HL)
            this.bitOps("bit", 6, this.memory.read(this.getHL()));
            this.pcIncrement(1);
            this.cycles.sumCycles(12);
            break;
          case 0x77:
          ...
          case 0x7e:
            //BIT 7, (HL)
            this.bitOps("bit", 7, this.memory.read(this.getHL()));
            this.pcIncrement(1);
            this.cycles.sumCycles(12);
            break;
          case 0x7f:
          ...
          case 0x86:
            ...
            this.memory.write(
              this.getHL(),
              this.bitOps("res", 0, this.memory.read(this.getHL()))
            );
            this.pcIncrement(1);
            this.cycles.sumCycles(16);
            break;
          ...
          case 0x8e:
            ...
            this.memory.write(
              this.getHL(),
              this.bitOps("res", 1, this.memory.read(this.getHL()))
            );
            this.pcIncrement(1);
            this.cycles.sumCycles(16);
            break;
          ...
          case 0x96:
            ...
            this.memory.write(
              this.getHL(),
              this.bitOps("res", 2, this.memory.read(this.getHL()))
            );
            this.pcIncrement(1);
            this.cycles.sumCycles(16);
            break;
          ...
          case 0x9e:
            ...
            this.memory.write(
              this.getHL(),
              this.bitOps("res", 3, this.memory.read(this.getHL()))
            );
            this.pcIncrement(1);
            this.cycles.sumCycles(16);
            break;
          ...
          case 0xa6:
            ...
            this.memory.write(
              this.getHL(),
              this.bitOps("res", 4, this.memory.read(this.getHL()))
            );
            this.pcIncrement(1);
            this.cycles.sumCycles(16);
            break;
          ...
          case 0xae:
            ...
            this.memory.write(
              this.getHL(),
              this.bitOps("res", 5, this.memory.read(this.getHL()))
            );
            this.pcIncrement(1);
            this.cycles.sumCycles(16);
            break;
          ...
          case 0xb6:
            ...
            this.memory.write(
              this.getHL(),
              this.bitOps("res", 6, this.memory.read(this.getHL()))
            );
            this.pcIncrement(1);
            this.cycles.sumCycles(16);
            break;
          ...
          case 0xbe:
            ...
            this.memory.write(
              this.getHL(),
              this.bitOps("res", 7, this.memory.read(this.getHL()))
            );
            this.pcIncrement(1);
            this.cycles.sumCycles(16);
            break;
          ...
          case 0xc6:
            ...
            this.memory.write(
              this.getHL(),
              this.bitOps("set", 0, this.memory.read(this.getHL()))
            );
            this.pcIncrement(1);
            this.cycles.sumCycles(16);
            break;
          ...
          case 0xce:
            ...
            this.memory.write(
              this.getHL(),
              this.bitOps("set", 1, this.memory.read(this.getHL()))
            );
            this.pcIncrement(1);
            this.cycles.sumCycles(16);
            break;
          ...
          case 0xd6:
            ...
            this.memory.write(
              this.getHL(),
              this.bitOps("set", 2, this.memory.read(this.getHL()))
            );
            this.pcIncrement(1);
            this.cycles.sumCycles(16);
            break;
          ...
          case 0xde:
            ...
            this.memory.write(
              this.getHL(),
              this.bitOps("set", 3, this.memory.read(this.getHL()))
            );
            this.pcIncrement(1);
            this.cycles.sumCycles(16);
            break;
          ...
          case 0xe6:
            ...
            this.memory.write(
              this.getHL(),
              this.bitOps("set", 4, this.memory.read(this.getHL()))
            );
            this.pcIncrement(1);
            this.cycles.sumCycles(16);
            break;
          ...
          case 0xee:
            ...
            this.memory.write(
              this.getHL(),
             this. bitOps("set", 5, this.memory.read(this.getHL()))
            );
            this.pcIncrement(1);
            this.cycles.sumCycles(16);
            break;
          ...
          case 0xf6:
            ...
            this.memory.write(
              this.getHL(),
              this.bitOps("set", 6, this.memory.read(this.getHL()))
            );
            this.pcIncrement(1);
            this.cycles.sumCycles(16);
            break;
          ...
          case 0xfe:
            ...
            this.memory.write(
              this.getHL(),
              this.bitOps("set", 7, this.memory.read(this.getHL()))
            );
            this.pcIncrement(1);
            this.cycles.sumCycles(16);
            break;
      ...
      case 0xce:
        //ADC A, n
        this.A = this.addSub("adc", this.A, this.memory.read(this.PC), 8);
        this.pcIncrement(1);
        this.cycles.sumCycles(8);
        break;
      case 0xcf:
      ...
      case 0xd6:
        //SUB A, n
        this.A = this.addSub("sub", this.A, this.memory.read(this.PC), 8);
        this.pcIncrement(1);
        this.cycles.sumCycles(8);
        break;
      case 0xd7:
      ...
      case 0xde:
        //SBC A, n
        this.A = this.addSub("sbc", this.A, this.memory.read(this.PC), 8);
        this.pcIncrement(1);
        this.cycles.sumCycles(8);
        break;
      case 0xdf:
      ...
      case 0xe6:
        //AND A, n
        this.A = this.logicalOps("and", this.A, this.memory.read(this.PC));
        this.pcIncrement(1);
        this.cycles.sumCycles(8);
        break;
      case 0xe7:
      ...
      case 0xe8:
        //ADD SP, n
        this.SP = this.addSub("add", this.SP, this.memory.read(this.PC), 16);
        this.pcIncrement(1);
        this.cycles.sumCycles(16);
        break;
      case 0xe9:
      ...
      case 0xee:
        //XOR A, n
        this.A = this.logicalOps("xor", this.A, this.memory.read(this.PC));
        this.pcIncrement(1);
        this.cycles.sumCycles(8);
        break;
      case 0xef:
      ...
      case 0xf6:
        //OR A, n
        this.A = this.logicalOps("or", this.A, this.memory.read(this.PC));
        this.pcIncrement(1);
        this.cycles.sumCycles(8);
        break;
      case 0xf7:
  ...
  addSub(
    ...
    if (op === "add" || op === "adc") {
      if (bits === 8) this.halfCarryFlag = (register & 0xf) + (value & 0xf) > 0xf;
